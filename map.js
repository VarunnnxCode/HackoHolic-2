...
function CalculateRoute()
{
    ...
    dirService.route(req,(result,status)=>{
        if(status==google.maps.DirectionsStatus.OK)
        {
            ...
            op.innerHTML="<div class='info'> From : &nbsp&nbsp&nbsp&nbsp&nbsp"+ document.getElementById("from").options[locIndex].text+"&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<span class='right'> To : &nbsp&nbsp&nbsp&nbsp&nbsp"+document.getElementById("to").options[desIndex].text+"</span> <br/> Walking Distance : &nbsp&nbsp&nbsp&nbsp&nbsp"+ result.routes[0].legs[0].distance.text + "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <span class='right'>Duration : &nbsp&nbsp&nbsp&nbsp&nbsp"+ result.routes[0].legs[0].duration.text+"</span></div>";
